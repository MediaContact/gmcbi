...
<a href="#" class="br-menu-link bg-danger active ">
	<div class="br-menu-item">
		...
		<span class="menu-item-label ">Ecoute qualité</span>
	</div> 
</a>
...
<a href="#" class="br-menu-link">
	<div class="br-menu-item">
		<i class="menu-item-icon ion-ios-barcode-outline tx-24"></i>
		<span class="menu-item-label">Notes et moyennes</span>
	</div> 
</a>
...
<a href="#" class="br-menu-link">
	<div class="br-menu-item">
		<i class="menu-item-icon ion-ios-barcode-outline tx-24"></i>
		<span class="menu-item-label">Cartographies</span>
	</div> 
</a>

<a href="<?php echo BASE_URL ?>/analytics/data/<?php echo $_SESSION['userInfodepartementId']; ?>" class="br-menu-link">
	<div class="br-menu-item">
