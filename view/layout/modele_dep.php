  ...
  <body>
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        <a href="<?php echo BASE_URL.DS?>dashboard" class="br-menu-link active">
         ...
         <a href="<?php echo BASE_URL.DS?>dashboard" class="br-menu-link">
          <div class="br-menu-item">
        ...
        <a href="#" class="br-menu-link">
          <div class="br-menu-item">
            ...
            <span class="menu-item-label">DAF</span>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          <a class="breadcrumb-item tx-bold tx-primary" href="#"><?php echo $ledepartement[0]->libelle_departement ?></a>
