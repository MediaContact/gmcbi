...
if(!$this->Session->isLogged()){
 //if($controller!='auths' )
    //header("Location:".Router::url("auths/connect")); 
}

if($this->Session->isLogged()){
  if($controller=='auths' )
     header("Location:".Router::url("dashboard/index")); 
}
...
<html lang="en">
  <head>
    ...
    <title><?php echo isset($title_for_layout)? 'GMC Business Intelligence Interface | '.$title_for_layout: 'GMC Business Intelligence Interface'; ?> </title>
  ...
  <body class="pt-1">
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="br-logo"><a href=""><span>[</span>GMC BI<span>]</span></a></div>
...
$_SESSION['idpays'] = 1;
        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name hidden-md-down font-bold"><?php echo $_SESSION['userInfoSurname'].' '.$_SESSION['userInfoName'] ?></span>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          <a class="breadcrumb-item tx-bold tx-primary" href="#"><?php if(isset($ledepartement[0]->libelle_departement)) echo $ledepartement[0]->libelle_departement ?></a>
    ...
    <script>
    // Dates picker pour la page de création de planning
        var nowTemp = new Date();
        var now = new Date(nowTemp.getFullYear(), nowTemp.getMonth(), nowTemp.getDate(), 0, 0, 0, 0);

        var checkin = $('#inputPeriodeDebut').datepicker({
          ...
          checkin.hide();
          $('#inputPeriodeFin')[0].focus();
        }).data('datepicker');

        var checkout = $('#inputPeriodeFin').datepicker({
          onRender: function(date) {
