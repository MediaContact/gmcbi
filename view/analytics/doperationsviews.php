			    ...
			    series: [{
			        ...
			        colorByPoint: true,
     			        ...
     			        <?php foreach ($donnees as $key => $value) {?>
     			        	   ['<?php echo $value->lemois ?>', <?php echo $value->valeur ?>],
     			     <?php   } ?>
      	...
      	<div id="linegrpahe" style=" height: 400px; margin: 0 auto"></div>
  	 	...
  	 	<script type="text/javascript">
			...
			Highcharts.chart('linegrpahe', {
			    ...
			    xAxis: {
			        categories: [ <?php foreach ($donnees as $key => $value) { ?>
			     			        	   '<?php echo $value->lemois ?>',
			     			        	   <?php } ?>
			     			        	   ]
			    },
			    ...
			    series: [
			    {
			        ...
			        data: [  <?php foreach ($donnees as $keys => $values) { 
			     			        	   echo $values->valeur.',';
			     			        	    } ?> 
			     			        	    ],
